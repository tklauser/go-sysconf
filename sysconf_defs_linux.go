...
const (
	...
	PC_ASYNC_IO           = C._PC_ASYNC_IO
	PC_PRIO_IO            = C._PC_PRIO_IO
	PC_FILESIZEBITS       = C._PC_FILESIZEBITS
	PC_REC_INCR_XFER_SIZE = C._PC_REC_INCR_XFER_SIZE
	PC_REC_MAX_XFER_SIZE  = C._PC_REC_MAX_XFER_SIZE
	PC_REC_MIN_XFER_SIZE  = C._PC_REC_MIN_XFER_SIZE
	PC_REC_XFER_ALIGN     = C._PC_REC_XFER_ALIGN
	PC_ALLOC_SIZE_MIN     = C._PC_ALLOC_SIZE_MIN
	PC_SYMLINK_MAX        = C._PC_SYMLINK_MAX
	PC_2_SYMLINKS         = C._PC_2_SYMLINKS
	PC_SOCK_MAXBUF        = C._PC_SOCK_MAXBUF

	_NAME_MAX  = C.NAME_MAX
	_PATH_MAX  = C.PATH_MAX
	_MAX_CANON = C.MAX_CANON
	_MAX_INPUT = C.MAX_INPUT
	_PIPE_BUF  = C.PIPE_BUF

	_POSIX_CHOWN_RESTRICTED = C._POSIX_CHOWN_RESTRICTED
	_POSIX_NO_TRUNC         = C._POSIX_NO_TRUNC
	_POSIX_VDISABLE         = C._POSIX_VDISABLE
)
